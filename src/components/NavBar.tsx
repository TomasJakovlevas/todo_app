...
const NavBar = () => {
  ...
  return (
    <nav className='mb-5 sm:mb-10 h-[50px] sm:h-[70px] flex items-center dark:shadow-[rgba(241,_245,_249,_0.1)_0px_9px_30px] shadow-[rgba(44,54,_57,_0.1)_0px_9px_30px]'>
